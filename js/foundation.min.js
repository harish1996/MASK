    ...
    Foundation.libs.accordion = {
        ...
        events: function() {
            ...
            c(this.scope).off(".fndtn.accordion").on("click.fndtn.accordion", "[" + this.attr_name() + "] > dd > a", function(d) {
                ...
                i = i.add("[" + f + "] dd")),
                g.toggleable && h.is(k) ? (h.parent("dd").toggleClass(g.active_class, !1),
...
function(a, b) {
    ...
    Foundation.libs.slider = {
        ...
        initialize_settings: function(b) {
            ...
            c.vertical ? (a.data(b, "bar_o", a(b).parent().offset().top),
...
function(a, b, c, d) {
    ...
    Foundation.libs.tab = {
        ...
        toggle_active_tab: function(e, f) {
            ...
            l = g(k)),
            n.deep_linking && (n.scroll_to_content ? (b.location.hash = f || k,
            f == d || f == k ? e.parent()[0].scrollIntoView() : g(k)[0].scrollIntoView()) : b.location.hash = f != d ? "fndtn-" + f.replace("#", "") : "fndtn-" + k.replace("#", "")),
